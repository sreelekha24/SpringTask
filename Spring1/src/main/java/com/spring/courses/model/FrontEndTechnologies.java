...
@Entity
@Table
public class FrontEndTechnologies implements Serializable {
	...
	public String toString() {
		return "FrontEndTechnologies [sId=" + sId + ", courseName=" + courseName + ", image=" + Arrays.toString(image)
				+ ", base64=" + base64 + ", mId=" + mId + ", file=" + Arrays.toString(file) + ", filename=" + filename
				+ ", base641=" + base641 + ", details=" + details + "]";
	}
